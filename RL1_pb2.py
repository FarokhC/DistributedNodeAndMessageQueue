...
_MESSAGEPASSING = _descriptor.ServiceDescriptor(
  name='MessagePassing',
  full_name='MessagePassing',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
...
_sym_db.RegisterServiceDescriptor(_MESSAGEPASSING)

DESCRIPTOR.services_by_name['MessagePassing'] = _MESSAGEPASSING
